...
struct modelEcoServiceFV <: mathematicalModel
    rF::Float64
    KF::Float64
    omega::Float64
    f::Float64
    ...
    function modelEcoServiceFV(modelParam::Dict{String, Float64})
        ...
        a, b, c, g = modelParam["a"], modelParam["b"], modelParam["c"], 
                        modelParam["g"]
       
        new(rF, KF, omega, f, muF, lambdaFH, rV, KV, alpha, muV, 
                    lambdaVH, gamma, betaF, betaH, a, b, c, g)
    end

end

function equationModel(model::modelEcoServiceFV, variables::Vector{Float64})
