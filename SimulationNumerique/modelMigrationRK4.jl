...
struct migrationRK4 <: numericalModel
    variablesNames::Vector{String}
    mathModel::modelMigration
    ...
    function migrationRK4(mathModel::modelMigration, numericalParam::Dict{String, Float64}, 
        ...
        result[:,1] = [t0, initialValues["HA0"], initialValues["FW0"], initialValues["VW0"]]
...
function numericalScheme(model::migrationRK4, variables::Vector{Float64})
...
function solveModel(model::migrationRK4)
