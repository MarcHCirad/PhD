...
struct hunterINSImplicit <: numericalModel
    ...
    function hunterINSImplicit(mathModel::modelHunterI, numericalParam::Dict{String, Float64}, 
...
function numericalScheme(model::hunterINSImplicit, variables::Vector{Float64})
    ...
    problem = LinearProblem(schemeMatrix, variables + [mModel.I*model.phiDt, mModel.IF * model.phiDt,0.])
    variablesN1 = solve(problem)
    
    return variablesN1
end

function solveModel(model::hunterINSImplicit)
