...
struct alleeEffectPrefRK4 <: numericalModel

    mathModel::modelAlleeEffectPref
    ...
    function alleeEffectPrefRK4(modelParam::Dict{String, Float64}, numericalParam::Dict{String, Float64}, 
                            initialValues::Dict{String, Float64})
        mathModel = modelAlleeEffectPref(modelParam)
    ...
    function alleeEffectPrefRK4(mathModel::modelAlleeEffectPref, numericalParam::Dict{String, Float64}, 
        initialValues::Dict{String, Float64})
...
function numericalScheme(model::alleeEffectPrefRK4, variables::Vector{Float64})
...
function solveModel(model::alleeEffectPrefRK4)
