...
struct hunterRK4 <: numericalModel
    ...
    function hunterRK4(mathModel::modelHunter, numericalParam::Dict{String, Float64}, 
        ...
        result[:,1] = [t0, initialValues["HA0"], initialValues["FW0"], initialValues["HW0"]]
...
function numericalScheme(model::hunterRK4, variables::Vector{Float64})
...
function solveModel(model::hunterRK4)
